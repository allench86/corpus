...
describe ParagraphsController do
  ...
  let(:valid_attributes) { { "language" => "1" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved paragraph as @paragraph" do
        ...
        post :create, {:paragraph => { "language" => "invalid value" }}, valid_session
        assigns(:paragraph).should be_a_new(Paragraph)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested paragraph" do
        ...
        Paragraph.any_instance.should_receive(:update_attributes).with({ "language" => "1" })
        put :update, {:id => paragraph.to_param, :paragraph => { "language" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the paragraph as @paragraph" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Paragraph.any_instance.stub(:save).and_return(false)
        put :update, {:id => paragraph.to_param, :paragraph => { "language" => "invalid value" }}, valid_session
        assigns(:paragraph).should eq(paragraph)
      end
